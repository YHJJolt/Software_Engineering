<%@ Page Title="People" Language="C#" MasterPageFile="~/Lecturer/LecturerCourseMaster.Master"
    AutoEventWireup="true" CodeBehind="CoursePeople.aspx.cs" Inherits="SchoolSystem.CoursePeople" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div id="cpNoResults" style="display:none; text-align:center; padding:40px 20px; color:#64748b; font-size:15px; font-weight:600;">
