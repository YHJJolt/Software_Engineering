...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
                ...
                <table class="courses-table" id="coursesTable">
                    ...
                    <tbody>
                        <asp:Repeater ID="rptCourses" runat="server">
                            <ItemTemplate>
                                <tr onclick="window.location.href='StudentCourseHome.aspx?id=<%# Eval("course_id") %>&session=<%# Uri.EscapeDataString(Eval("academic_session").ToString()) %>'">
                                    ...
                                    <td class="col-sem"><span class="sem-pill"><%# Eval("academic_session") %></span></td>
                                    <td>
    ...
    <script>
        ...
        // Hide the Session column when a specific session is selected
        (function () {
