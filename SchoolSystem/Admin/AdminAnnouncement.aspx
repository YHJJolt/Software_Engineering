<%@ Page Title="Announcements Management" Language="C#" MasterPageFile="~/Admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="AdminAnnouncement.aspx.cs" Inherits="SchoolSystem.AdminAnnouncement" %>
...
<asp:Content ID="ContentTitle" ContentPlaceHolderID="TopbarTitle" runat="server">
    <h1 style="margin: 0; font-size: 24px; color: #1e293b;">
        <i class="fas fa-bullhorn" style="margin-right: 10px;"></i>Announcements
    </h1>
</asp:Content>
