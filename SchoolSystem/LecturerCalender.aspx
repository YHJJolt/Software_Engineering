<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LecturerCalender.aspx.cs" 
...
$(document).ready(function () {
    ...
    calendar = new FullCalendar.Calendar(calendarEl, {
        ...
        events: function (fetchInfo, successCallback) {
            $.when(
                $.ajax({ url: 'LecturerCalender.aspx/GetEvents', type: 'POST', contentType: 'application/json', data: '{}' }),
                $.ajax({ url: 'LecturerCalender.aspx/GetAdminEvents', type: 'POST', contentType: 'application/json', data: '{}' })
...
function saveEvent() {
    ...
    $.ajax({
        url: 'LecturerCalender.aspx/AddEvent',
        type: 'POST',
...
function updateEvent() {
    ...
    $.ajax({
        url: 'LecturerCalender.aspx/UpdateEvent',
        type: 'POST',
        contentType: 'application/json',
        data: JSON.stringify({
...
function deleteEvent(id) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            $.ajax({
                url: 'LecturerCalender.aspx/DeleteEvent',
                type: 'POST',
